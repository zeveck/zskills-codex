...
4. When Codex sub-agents are available, run an independent adversarial review of the remaining phases and incorporate or explicitly reject its findings. If sub-agents are unavailable, perform inline adversarial review and disclose the lower assurance.
